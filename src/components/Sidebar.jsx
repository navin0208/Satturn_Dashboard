...
import { LayoutDashboard, MapPin, Activity, MonitorSmartphone, Settings, Users, X, FileText, Cpu } from 'lucide-react';
      ...
      {user?.role === 'ADMIN' && (
        <div className="nav-section">
          ...
          <ul>
            ...
            <li>
              <NavLink onClick={onClose} to="/dashboard/admin/aqms-systems" className={({isActive}) => isActive ? "nav-link active" : "nav-link"}>
                <Cpu size={18} />
                AQMS Systems
              </NavLink>
            </li>
